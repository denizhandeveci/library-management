...
INSERT INTO admins (id, version, created, updated, deleted,
                    name, email, phone_number, address, password_hash)
VALUES (1, 0, NOW(6), NOW(6), NULL,
        'Admin User', 'admin@example.com', '+49 111 111111', 'Admin Street 1, Darmstadt',
        '{bcrypt}$2a$10$r.Ut4IevCMxwg2uhLBzCAefhJLRbToaIVuDLsTFCB5vT7Jx.NI9k6');

INSERT INTO users (id, version, created, updated, deleted,
                   name, email, phone_number, address, password_hash)
VALUES (1, 0, NOW(6), NOW(6), NULL,
        'Alice Müller', 'alice@example.com', '+49 151 11111111', 'Rheinstraße 1, Darmstadt',
        '{bcrypt}$2a$10$PhnhT9RTCh2ch5ggyMTbpeEc1dJe1r6aaNKsVgNTYut/kqxO5rl1y'),

       (2, 0, NOW(6), NOW(6), NULL,
        'Bob Schneider', 'bob@example.com', '+49 151 22222222', 'Berliner Allee 2, Darmstadt',
        '{bcrypt}$2a$10$PhnhT9RTCh2ch5ggyMTbpeEc1dJe1r6aaNKsVgNTYut/kqxO5rl1y'),

       (3, 0, NOW(6), NOW(6), NULL,
        'Clara Weber', 'clara@example.com', '+49 151 33333333', 'Luisenplatz 3, Darmstadt',
        '{bcrypt}$2a$10$PhnhT9RTCh2ch5ggyMTbpeEc1dJe1r6aaNKsVgNTYut/kqxO5rl1y');

INSERT INTO books (id, version, created, updated, deleted,
...
INSERT INTO loans (id, version, created, updated, deleted,
...
INSERT INTO reservations (id, version, created, updated, deleted,
...
INSERT INTO reviews (id, version, created, updated, deleted,
